...
```bash
sudo apt update
sudo DEBIAN_FRONTEND=noninteractive apt install ./odm-client_0.10.18_amd64.deb
...
```bash
bash packaging/deb/build-in-container.sh 0.10.18   # -> dist/odm-client_0.10.18_amd64.deb
```

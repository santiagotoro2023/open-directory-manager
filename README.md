...
```bash
sudo apt update
sudo DEBIAN_FRONTEND=noninteractive apt install ./odm-client_0.8.11_amd64.deb
...
```bash
bash packaging/deb/build-in-container.sh 0.8.11   # -> dist/odm-client_0.8.11_amd64.deb
```

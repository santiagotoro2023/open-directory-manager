...
```bash
sudo apt update
sudo DEBIAN_FRONTEND=noninteractive apt install ./odm-client_0.14.0_amd64.deb
...
```bash
bash packaging/deb/build-in-container.sh 0.14.0   # -> dist/odm-client_0.14.0_amd64.deb
```

...
```bash
sudo apt update
sudo DEBIAN_FRONTEND=noninteractive apt install ./odm-client_0.9.6_amd64.deb
...
```bash
bash packaging/deb/build-in-container.sh 0.9.6   # -> dist/odm-client_0.9.6_amd64.deb
```

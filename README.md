...
```bash
sudo apt update
sudo DEBIAN_FRONTEND=noninteractive apt install ./odm-client_0.17.3_amd64.deb
...
```bash
bash packaging/deb/build-in-container.sh 0.17.3   # -> dist/odm-client_0.17.3_amd64.deb
```

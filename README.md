...
```bash
sudo apt update
sudo DEBIAN_FRONTEND=noninteractive apt install ./odm-client_0.13.4_amd64.deb
...
```bash
bash packaging/deb/build-in-container.sh 0.13.4   # -> dist/odm-client_0.13.4_amd64.deb
```

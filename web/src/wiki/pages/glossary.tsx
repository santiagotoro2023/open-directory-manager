        ...
        <Section title="Directory">
          <Reference
            ...
            rows={[
              ...
              [
                "Organizational unit",
                "A container. Policy links and delegation scopes attach to it.",
              ],
              [
                "Built-in container",
                "A container created with the domain, such as Users or Computers.",
              ],
              [
                "Security identifier",
                "The stable identifier a principal is known by. Access rules name it.",
              ],
              [
                "Account name",
                "The short logon name. A computer account's ends with a dollar sign.",
              ],
              [
                "User principal name",
                "A logon name in e-mail form, such as ada@corp.example.internal.",
              ],
              ["Nesting", "A group holding another group. Membership follows through it."],
              [
                "User group",
                "A group that holds people. Used for sudo rules, HBAC rules, delegation and policy filtering.",
              ],
              [
                "Computer group",
                "A group that holds computers. Used for policy filtering and item-level targeting.",
              ],
        ...
        <Section title="Policy">
          <Reference
            ...
            rows={[
              ...
              [
                "Enforced",
                "A link applied after every unenforced one, surviving blocked inheritance.",
              ],
              ...
              [
                ...
                "Restricting by operating system, host name, group or address.",
              ],
              ["Effective policy", "The merged result of everything that applies to one object."],
              [
                "Resultant Set of Policy",
                "What should apply, and what a machine reported applying.",
              ],
              [
                "Policy serial",
                "A fingerprint of the effective policy, used to skip unchanged work.",
              ],
            ]}
          />
        </Section>
          ...
          <Reference
            ...
            rows={[
              ...
              [
                ...
                "A service's principal, such as HTTP/odm.corp.example.internal.",
              ],
              [
                "Keytab",
                "A file holding a principal's long-term keys, used to authenticate without a password.",
              ],
          ...
          <Reference
            ...
            rows={[
              ...
              [
                ...
                "A link between two controllers over which changes flow.",
              ],
          ...
          <Reference
            ...
            rows={[
              ...
              [
                ...
                "A member of the group the console is gated on. Holds everything.",
              ],
            ]}
          />
        </Section>
